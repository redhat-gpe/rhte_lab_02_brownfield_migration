...
+
NOTE: For the labs, the output from running the above rule is provided through http://rhte-httpd-server.apps.40b3.rhte.opentlc.com[URL^]
...
. View the reports in browser by opening the URL:
